...
describe('Central de Atendimento ao Cliente TAT', () => {
   ...
   it('preenche os campos obrigatórios e envia o formulário', () => {
      ...
      cy.get('#email').type('rafya@gmail.com')
   ...
   it('campo telefone continua vazio quando preencido com valor não numérico', () => {
      cy.get('#phone').type('abcdefgj').should('have.value', '')
   })
   ...
   it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
      ...
      cy.get('#email')
         .type('rafya@gmail.com')
         .should('have.value', 'rafya@gmail.com')
         .clear()
         .should('have.value', '')
